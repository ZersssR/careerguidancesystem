...
<body>
    ...
    <div class="content">
        ...
        <h3 class="i-name">Students Chart</h3>
...
<div class="val-box">
                    <i class="fa fa-users"></i>
                    <div>
                        <a href="chartbyclass.php">View Chart By Class</a>
                    </div>
                </div>
                <div class="val-box">
                    <i class="fa fa-home"></i>
                    <div>
                        <a href="chartbygender.php">View Chart By Gender</a>
                    </div>
                </div>
                <div class="val-box">
                    <i class="fa fa-heart"></i>
                    <div>
                        <a href="studentchart.php">View Chart Overall</a>
                    </div>
                </div>
            </div>
